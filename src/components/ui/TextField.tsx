...
export function TextField({
  ...
  const inputClassName = [
    'h-11 w-full rounded-xl border border-zinc-200 bg-white px-3 text-base text-zinc-900 outline-none transition focus:border-zinc-400 sm:text-sm dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100 dark:focus:border-zinc-600',
    endAdornment ? 'pr-11' : '',
  ]
    .filter(Boolean)
    .join(' ');
